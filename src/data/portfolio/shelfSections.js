...
export const shelfSections = [
    {
        ...
        rowTop: "19%",
        cardHeight: "clamp(8.1rem, 6.75vw, 11.52vw)",
        cardWidth: "clamp(7.09rem, 7.34vw, 12.24vw)",
    ...
    },
    {
        ...
        rowTop: "38.8%",
        cardHeight: "clamp(7.56rem, 6.44vw, 10.89vw)",
        cardWidth: "clamp(6.75rem, 7.07vw, 11.7vw)",
        rotation: { y: 10, z: -0.5 },
        autoScrollSpeed: 15,
        doRepeat: true,
        items: [
    ...
    },
    {
        ...
        rowTop: "56.9%",
        cardHeight: "clamp(6.75rem, 5.81vw, 9.81vw)",
        cardWidth: "clamp(4.86rem, 5.13vw, 8.46vw)",
        rotation: { y: 10, z: 0.0 },
        autoScrollSpeed: 20,
        doRepeat: true,
        items: [
    ...
    },
    {
        ...
        rowTop: "74%",
        cardHeight: "clamp(6.3rem, 5.49vw, 9.27vw)",
        cardWidth: "clamp(6.75rem, 7.07vw, 11.7vw)",
