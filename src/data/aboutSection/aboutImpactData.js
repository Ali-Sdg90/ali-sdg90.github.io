...
Looking after the interns, guiding them, watching them grow, and seeing the impact I could have on their technical journey was something I really loved about this experience.`,
        storyFA: `این یکی از دوست‌داشتنی‌ترین تجربه‌های من در برنامه CS Internship بود.
...
It was another part of my work that I genuinely enjoyed. Helping someone go from being completely new to the project to feeling comfortable working inside the team was nice to see.`,
        storyFA: `شرکت ملک رادار خودش مسیر آنبوردینگ، ویدئوها، داکیومنت‌ها و آموزش‌های لازم برای اعضای جدید رو داشت. ولی همچنان نیاز بود یک نفر کنار هر عضو جدید باشه، حواسش به مسیر آنبوردینگش باشه، سوال‌هاش رو جواب بده و کمک کنه با روال تیم آشنا بشه. خوشحال بودم که برای این نقش به من اعتماد میشد.
...
دیدن اینکه یک نفر از روز اولی که وارد تیم میشه و همه چیز براش جدیده، کم کم با پروژه و تیم آشنا میشه و میتونه مستقل کارش رو پیش ببره، برام تجربه دوست‌داشتنی‌ای بود.`,
    ...
    technicalSessions: {
        ...
        storyTitle: "Story",
        storyEN: `For around two years, I was a technical mentor in the CS Internship program and held technical sessions for web development interns.
...
One of my favorite parts of being in the program was these weekly sessions. Every week I got to sit down with interns, see what they had been working on, hear their questions, and talk through the things they were dealing with. I really enjoyed these sessions.`,
        storyFA: `حدود ۲ سال در برنامه CS Internship منتور فنی بودم و توی این مدت برای اینترن‌های دوره وب جلسات فنی برگزار می‌کردم.
...
Askly90 was a small experimental bot I built for myself and a friend. Whenever a question came up in a Telegram chat, we could mention the bot with the question. It would send it to Perplexity's LLM and reply directly inside the conversation. It was really useful while it was running, but because it had an ongoing cost, I shut it down after around two months.`,
        storyFA: `من ساختن بات تلگرام رو خیلی دوست دارم.
...
Askly90 یه بات آزمایشی بود که برای خودم و یکی از دوست‌هام ساختم. وقتی وسط چت تلگرام سوالی برامون پیش میومد، بات رو صدا می‌زدیم و سوالمون رو جلوی اسمش می‌نوشتیم. بات سوال رو برای LLM پرپلاکسیتی می‌فرستاد و جواب رو مستقیم تو همون چت ریپلای می‌کرد. برای مدتی که کار می‌کرد خیلی کاربردی بود، ولی چون استفاده ازش برام هزینه داشت بعد از حدود ۲ ماه خاموشش کردم.`,
    ...
    internalTools: {
        ...
        storyTitle: "Story",
        storyEN: `I like automating things that can be automated.
...
I really enjoyed building these systems. Seeing a repetitive or frustrating process, building a clean and practical tool for it, and then watching it actually become part of the workflow and get used is one of the things I love most about working.`,
        storyFA: `من دوست دارم چیزی که می‌تونه اتومات بشه رو اتومات کنم.
...
ساختن این سیستم‌ها رو خیلی دوست داشتم. اینکه یه پروسه تکراری یا آزاردهنده رو ببینم، براش یه ابزار تمیز و کار راه‌بند بسازم و بعد ببینم واقعا وارد روال کار شده و آدم‌ها دارن ازش استفاده می‌کنند، یکی از دوست‌داشتنی‌ترین حس‌های کار کردن برام هست.`,
    ...
    androidAppShipped: {
        ...
        storyTitle: "Story",
        storyEN: `Android development wasn't something I originally expected to get into.
...
The app and my developer signing setup also went through Google Play Protect's verification process. There's a more detailed explanation of Health Data Relay in the Featured Projects section.`,
        storyFA: `ساخت اپ اندروید چیزی نبود که اولش فکر کنم یه روز میرم سمتش.
...
It was one of the most challenging projects we had worked on, but also a really cool experience for both of us. We started with an idea and a very early prototype and ended up with something real that actually worked and that we could ship.`,
        storyFA: `Settle It GPT اولین اپ موبایلی بود که به‌صورت جدی روش کار کردم.
...
تجربه خیلی خفنی برای هردومون بود. از یه ایده و یه نسخه خیلی پایه شروع کردیم و در نهایت چیزی ساختیم که واقعا کار می‌کرد و تونستیم شیپش کنیم.`,
    ...
    pullRequestsReviewed: {
        ...
        storyTitle: "Story",
        storyEN: `I joined MelkRadar as a frontend developer, but after some time I was trusted with reviewing and overseeing the work of other frontend team members.
...
Both I and the company were happy with how the role went during the time I had it. It was a demanding responsibility, but also a really interesting experience for me.`,
        storyFA: `من به عنوان نیروی فرانت وارد شرکت ملک‌رادار شدم، ولی بعد از مدتی مسئول ریویو و نظارت روی کار بقیه اعضای تیم فرانت شدم.
...
هم خودم و هم شرکت از مدتی که این نقش رو داشتم راضی بودیم. مسئولیت سنگینی بود، ولی تجربه خیلی باحالی برام بود.`,
    ...
    openSourceCommits: {
        ...
        storyTitle: "Story",
        storyEN: `I've spent a good amount of time working on open-source projects.
...
It's something I know I'll want to keep doing in the future too.`,
        storyFA: `روی پروژه‌های اوپن سورس هم فعالیت نسبتا زیادی داشتم.
